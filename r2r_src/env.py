...
class R2RBatch():
    ...
    def __init__(self, feature_store, batch_size=100, seed=None, splits=['train'], tokenizer=None,
                 name=None):
        ...
        self.splits = splits
        self.seed = seed if seed is not None else (args.seed + 9 if args.seed is not None else None)
